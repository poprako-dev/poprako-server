...
| it_07 | `it_07_workflow_sysmail.ts` | Workflow transitions, localized immutable activity records without repository payload JSON, pagination, and deferred system mail. |
