...
// use crate::infra::repo::memory_mock::MemoryMockRepoTransactional;
// 
// #[async_trait]
// impl MemberInvitationRepoTransactional for MemoryMockRepoTransactional {
...
// #[cfg(test)]
// mod tests {
//     // find_pending_by_code(MemberInvitationRepoTransactional::get_by_code_ex)(positive): pending invitations should be found by code.
//     // get_by_code_ex_no_pending_returns_expected_error(MemberInvitationRepoTransactional::get_by_code_ex)(negative): missing pending invitations should return an expected argument error.
//     // mark_pending_as_used_then_not_found(MemberInvitationRepoTransactional::mark_pending_as_used)(positive): marking an invitation used should make it unavailable by code.
//     // mark_pending_as_used_nonexistent_returns_error(MemberInvitationRepoTransactional::mark_pending_as_used)(negative): marking an unknown invitation should return an expected argument error.
// 
...
//             async move {
//                 let inv = MemberInvitationRepoTransactional::get_by_code_excluded(txn, "CODE123")
//                     .await
//                     .unwrap();
...
//                 async move {
//                     MemberInvitationRepoTransactional::get_by_code_excluded(txn, "NOPE").await
//                 }
//                 .boxed()
//             })
//             .await
...
//         mock.transaction_scoped(|txn| {
//             async move {
//                 MemberInvitationRepoTransactional::mark_pending_as_used(txn, "inv-1")
//                     .await
//                     .unwrap();
//                 Ok(())
//             }
...
//             .transaction_scoped(|txn| {
//                 async move {
//                     MemberInvitationRepoTransactional::get_by_code_excluded(txn, "CODE123").await
//                 }
//                 .boxed()
//             })
//             .await
...
//             .transaction_scoped(|txn| {
//                 async move {
//                     MemberInvitationRepoTransactional::mark_pending_as_used(txn, "nope").await
//                 }
//                 .boxed()
//             })
//             .await
