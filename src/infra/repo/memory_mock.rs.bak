...
// 
// /// In-memory store for mock repo implementations.
// ///
...
// }
// 
// // ── Non-transactional repo handle ─────────────────────────────────────────
// 
// /// Repo handle backed by in-memory state.
// ///
...
//     /// Creates a new mock repo with an empty state.
//     pub fn new() -> Self {
//         Self {
...
// }
// 
// // ── Transaction-scoped repo handle ────────────────────────────────────────
// 
// /// Mutable repo handle passed to closures inside
...
// pub struct MemoryMockRepoTransactional {
//     state: Arc<Mutex<MemoryMockState>>,
// }
// 
// // ── Transactional impl ─────────────────────────────────────────────────────
...
//     type Repo<'a> = MemoryMockRepoTransactional;
// 
...
//         let mut repo = MemoryMockRepoTransactional {
//             state: Arc::clone(&self.state),
//         };
//         let res = f(&mut repo).await;
// 
//         if res.is_err() {
