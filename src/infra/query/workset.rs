...
pub async fn get_by_id(conn: &mut AsyncPgConnection, workset_id: &str) -> DomainResult<WorksetAggr> {
...
pub async fn list(
    ...
    use crate::infra::query::schema::t_team;
...
pub async fn update_comic_count(
    ...
    let current: i32 = t_workset
        ...
        .await
        .optional()?
        .ok_or_else(|| DomainError::expected_argument(trl(
            "error-workset-not-found",
        )))?;
...
#[async_trait]
impl WorksetQuery for RdbQuery {
    ...
    async fn list(
        ...
        submit_query!(self.pool, list, team_id, offset, limit)
    }
...
#[async_trait]
impl<'c> WorksetQueryTransactional for RdbQueryTransactional<'c> {
