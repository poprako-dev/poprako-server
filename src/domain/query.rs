...
use crate::domain::query::system_mail::{SystemMailQuery, SystemMailQueryForward};
use crate::domain::query::team::{TeamQuery, TeamQueryForward, TeamQueryTransactional};
use crate::domain::query::user::{UserQuery, UserQueryForward, UserQueryTransactional};
use crate::domain::query::workset::{WorksetQuery, WorksetQueryForward, WorksetQueryTransactional};
...
use crate::domain::query::local_message::LocalMessageQueryForward;
use crate::domain::query::member::MemberQueryForward;

/// Composite read-only query contract for non-transactional use cases.
#[forward_ref_super]
pub trait Query:
    UserQuery + TeamQuery + SystemMailQuery + WorksetQuery + MemberQuery + LocalMessageQuery
{
}

impl<T> Query for T where
    T: UserQuery + TeamQuery + SystemMailQuery + WorksetQuery + MemberQuery + LocalMessageQuery
{
}
...
pub trait QueryTransactional:
    ...
    + LocalMessageQueryTransactional
{
}
