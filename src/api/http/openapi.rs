...
#[openapi(
    paths(
        ...
        handler::chapter_port::alloc_artwork,
        handler::chapter_port::mark_artwork_uploaded,
        handler::chapter_port::export_artwork,
    ...
    components(schemas(
        ...
        PageUnitDiffStatsVal, PageUnitFlaggedStatsVal,
        UnitEditInstr,
        UnitCoordInstr,
        UnitTranslationInstr,
        UnitRevisionInstr,
